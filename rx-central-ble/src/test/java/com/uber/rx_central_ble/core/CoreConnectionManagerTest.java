...
public class CoreConnectionManagerTest  {
  ...
  @Mock GattIO gattIO;
  @Mock AdvertisingData advertisingData;
  ...
  private final PublishSubject<AdvertisingData> scanDataPublishSubject = PublishSubject.create();
  ...
  public void setup() {
    ...
    when(advertisingData.getBluetoothDevice()).thenReturn(bluetoothDevice);
  ...
  public void connect_failed_connectFailed() {
    ...
    scanDataPublishSubject.onNext(advertisingData);
  ...
  private void prepareConnect(boolean matcherEquals) {
    scanMatcher =
        new ScanMatcher() {
          @Override
          public boolean match(AdvertisingData advertisingData) {
            return true;
          }
