 ...
 */
package com.uber.rxcentralble.deprecated;
...
public class DirectUnsupportedConnectionManager implements ConnectionManager {
  ...
  public DirectUnsupportedConnectionManager(Context context) {
    this(context, new CoreBluetoothDetector(context));
  }

  public DirectUnsupportedConnectionManager(Context context, BluetoothDetector bluetoothDetector) {
    this(context, bluetoothDetector, new CoreGattIO.Factory());
  }

  public DirectUnsupportedConnectionManager(
          Context context,
