...
public class CoreConnectionManager implements ConnectionManager {
  ...
  public CoreConnectionManager(
    ...
    Scanner scanner;
    AdvertisingData.Factory factory = new CoreAdvertisingData.Factory();
  ...
  private ObservableTransformer<Optional<ScanMatcher>, AdvertisingData> scan(Scanner scanner) {
  ...
  private ObservableTransformer<AdvertisingData, GattIO> connectGatt(
